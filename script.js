...
function mediaAritmetica(event) {
    ...
    if (result >= 7) {
        texto.innerHTML = "Aluno/a aprovado, com a média de:" + result.toFixed(2)
    }
    else if (result >= 5 && result <= 6.9) {
        texto.innerHTML = "Aluno/a de exame, com a média de: " + result.toFixed(2)
    }
    else if (result < 5) {
        texto.innerHTML = "Aluno/a reprovado, com a média de: " + result.toFixed(2)
    }
}
...
function mediaPonderada(event) {
    ...
    if (result2 >= 7) {
        texto2.innerHTML = "Aluno/a, aprovado com a média de: " + result2.toFixed(2)
    }
    else if (result2 >= 5 && result2 <= 6.9) {
        texto2.innerHTML = "Aluno/a está de exame, com a média de: " + result2.toFixed(2)
    }
    else if (result2 < 5) {
        texto2.innerHTML = "Aluno/a reprovado, com a média de: " + result2.toFixed(2)
    }
}
